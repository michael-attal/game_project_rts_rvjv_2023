...
//// todo - come back and fix this someday.... it broke and now i no longer use the header line
...
//        _Shift("Offset based on clip index, time, play speed, frame rate [_Shift]", Float) = 0
//        _Stat1("Pow2, MinPos, MaxPos [_Stat1]", Vector) = (0, 0, 0, 0)
...
//                    UNITY_DOTS_INSTANCED_PROP(float, _Shift)
//                    UNITY_DOTS_INSTANCED_PROP(float4, _Stat1)
...
//                #define _Shift UNITY_ACCESS_DOTS_INSTANCED_PROP(float, _Shift)
//                #define _Stat1 UNITY_ACCESS_DOTS_INSTANCED_PROP(float4, _Stat1)
...
//                //float3 position = DerivePos(_PosMap_TexelSize, _PosMap, _SpeedInst, _SpeedMat, _ClipIdx, _CurTime, vertexId);
//                //float3 position = DerivePos(_PosMap_TexelSize, _PosMap, vertexId, _Shift);
//                float3 position = DeriveValue(_PosMap, _PosMap_TexelSize, vertexId, _Shift, _Stat1.x, _Stat1.y, _Stat1.z);
